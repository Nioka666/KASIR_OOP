        ...
        <form action="" method="post" class="" id="data-input-fill">
            ...
            <div>
                ...
                <input type="text" name="total_harga" id="total_harga" class="form-control">
                 <input type="number" name="bayar" id ="bayar" class="form-control" oninput="Kembalian()">
                 <input type="number" name="kembalian" id="kembalian" class="form-control" readonly>
            </div>
            <div class="form-group col-lg-12 mt-4">
                <button type="submit" name="simpan" class="btn w-100 btn-primary">bayar</button>
                <button type="submit" name="cetak" class="mt-2 btn w-100 btn-primary" formaction="cetak_nota.php?id=<?= $_GET['id'] ?>">Cetak</button>
<!-- <?php
...
if (isset($_POST['simpan'])) {
    ...
    $result2 = $db->query("UPDATE penjualan SET bayar=$bayar,kembalian=$kembali WHERE id=$id");
...
<script>
    ...
    function Kembalian() {  
        let total = document.getElementById("total_harga_penjualan").value;
        let bayar = document.getElementById("bayar").value;
        let kembalian = bayar - total;
        document.getElementById("kembalian").value =  kembalian >= 0  ? kembalian : "Bayar Masih Kurang";
    }
</script>